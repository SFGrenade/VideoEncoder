...
public static class NativeWrapper
{
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    private static extern bool Native_Linux_SendRawBytes([MarshalAs(UnmanagedType.LPArray)] byte[] bytes, [MarshalAs(UnmanagedType.I4)] int size, [MarshalAs(UnmanagedType.I4)] int width, [MarshalAs(UnmanagedType.I4)] int height);
    private static bool Linux_SendRawBytes_Wrap(byte[] bytes, int width, int height) => Native_Linux_SendRawBytes(bytes, bytes.Length, width, height); 
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    private static extern bool Native_MacOS_SendRawBytes([MarshalAs(UnmanagedType.LPArray)] byte[] bytes, [MarshalAs(UnmanagedType.I4)] int size, [MarshalAs(UnmanagedType.I4)] int width, [MarshalAs(UnmanagedType.I4)] int height);
    private static bool MacOS_SendRawBytes_Wrap(byte[] bytes, int width, int height) => Native_MacOS_SendRawBytes(bytes, bytes.Length, width, height);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    private static extern bool Native_Windows_SendRawBytes([MarshalAs(UnmanagedType.LPArray)] byte[] bytes, [MarshalAs(UnmanagedType.I4)] int size, [MarshalAs(UnmanagedType.I4)] int width, [MarshalAs(UnmanagedType.I4)] int height);
    private static bool Windows_SendRawBytes_Wrap(byte[] bytes, int width, int height) => Native_Windows_SendRawBytes(bytes, bytes.Length, width, height);
    internal static bool SendRawBytes(byte[] bytes, int width, int height)
    {
        switch (SystemInfo.operatingSystemFamily)
        {
            case OperatingSystemFamily.Linux:
                return Linux_SendRawBytes_Wrap(bytes, width, height);
            case OperatingSystemFamily.MacOSX:
                return MacOS_SendRawBytes_Wrap(bytes, width, height);
            case OperatingSystemFamily.Windows:
                return Windows_SendRawBytes_Wrap(bytes, width, height);
            default:
                return false;
        };
    }
